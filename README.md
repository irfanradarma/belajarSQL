...
- Only `SELECT`/`WITH` statements are accepted; a deny-list additionally rejects mutating keywords server-side, independent of whatever permissions the connecting login actually has.
